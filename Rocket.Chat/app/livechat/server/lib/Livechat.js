...
import {
	sendMessage
} from '../../../lib/server/functions/sendMessage';
import {
	updateMessage
} from '../../../lib/server/functions/updateMessage';
import {
	deleteMessage
} from '../../../lib/server/functions/deleteMessage';
import {
	FileUpload
...
export const Livechat = {
	...
	getNextAgent(department, token) {
		return RoutingManager.getNextAgent(department, token);
	},
