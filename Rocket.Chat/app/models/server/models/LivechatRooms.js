	...
	getAnalyticsMetricsBetweenDate(t, date, {
		...
		if (type == 'department') {
			const query = {
				...
				//'servedBy._id': departmentId,
				...departmentId && departmentId !== 'undefined' && {
					departmentId
				},
			};

			console.log("inside department analtics bw date");
			return this.find(query, {
				fields: {
					ts: 1,
					departmentId: 1,
			...
			console.log("inside agent analtics bw date");
			return this.find(query, {
				fields: {
					ts: 1,
					departmentId: 1,
